...
## 美术规范
- **规格**: 地块统一 32x32 像素，图标 64x64，头像 256x256。
- **色板**: 低饱和大地色（赭石、靛青、墨绿、土黄）。
- **命名**: 
  - 地块: `tile_terrain_[名称].png`
  - 单位: `unit_[国家]_[名称].png`
  - 图标: `icon_school_[名称].png`

## 开发常用指令
- **测试**: `npm test` (或其他你的测试命令)
- **生图脚本**: `python scripts/generate_placeholder.py`

## 逻辑约束
- 优先使用 Python Pillow 生成占位素材。
- 必须严格考据战国历史细节。