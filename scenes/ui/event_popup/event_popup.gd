...
func _build_ui() -> void:
	...
	popup_style.bg_color = Color(0.08, 0.07, 0.05, 0.96)
	popup_style.border_color = Color(0.46, 0.36, 0.2, 1.0)
	popup_style.set_border_width_all(2)
	popup_style.set_corner_radius_all(6)
	popup_style.content_margin_left = 18.0
	popup_style.content_margin_right = 18.0
	popup_style.content_margin_top = 18.0
	popup_style.content_margin_bottom = 18.0
	...
	action_row.add_child(_options_container)

	var effect_panel := PanelContainer.new()
	effect_panel.name = "EffectPreviewPanel"
	effect_panel.custom_minimum_size = Vector2(170, 0)
	action_row.add_child(effect_panel)

	var effect_margin := MarginContainer.new()
	effect_margin.add_theme_constant_override("margin_left", 10)
	effect_margin.add_theme_constant_override("margin_top", 10)
	effect_margin.add_theme_constant_override("margin_right", 10)
	effect_margin.add_theme_constant_override("margin_bottom", 10)
